...
@RuntimePermissions
public class AddTempleActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        topToolBar.setTitle("Suggest adding a Temple");
        ...
        AddTempleActivityPermissionsDispatcher.checkLocationWithPermissionCheck(this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        AddTempleActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
